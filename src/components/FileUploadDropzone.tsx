...
export default function FileUploadDropzone({
  ...
  return (
    <div className='flex flex-col'>
      ...
      {/* Dropzone Area */}
      <div
        className={`flex-grow flex items-center justify-center border-2 border-dashed rounded-lg p-8 text-center group transition-colors cursor-pointer ${borderStyle}`}
        ...
        {fileName ? (
          ...
          <div className='flex flex-col items-center pointer-events-none'>
            ...
            <p className='text-gray-500 dark:text-gray-400 text-sm'>
              ...
              <span
                className='font-semibold text-primary hover:underline pointer-events-auto'
                onClick={handleUploadClick}
              >
                hochladen
              </span>
